        ...
        for batch in train_loader:
            ...
            if d_steps_left > 0:
                ...
                losses_g = generator_step(args, batch, generator,
                                          ...
                                          optimizer_g, processed_local_info)
            ...
            if t > 0 and t % args.checkpoint_every == 0:
                ...
                checkpoint_path = os.path.join(
                    args.output_dir, '%s_with_model' % args.checkpoint_name + "_t" + str(t) + ".pt"
                )
...
def generator_step(
    ...
    for _ in range(args.best_k):
        generator_out = generator(obs_traj, obs_traj_rel, seq_start_end, all_local_info=processed_local_info) #NHI: input local info
    ...
    with torch.no_grad():
        for batch in loader:
            ...
            pred_traj_fake_rel = generator(
                obs_traj, obs_traj_rel, seq_start_end, all_local_info = processed_local_info # NHI: input local_info 
            )
            pred_traj_fake = relative_to_abs(pred_traj_fake_rel, obs_traj[-1])
